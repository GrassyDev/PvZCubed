        ...
        Box box = PvZEntity.BERSERKER.getDimensions().getBoxAt(vec3d.getX(), vec3d.getY(), vec3d.getZ());
            if (world.isSpaceEmpty((Entity) null, box, (entity) -> {
                ...
                if (world instanceof ServerWorld) {
                    ...
                    BerserkerEntity berserkerEntity = (BerserkerEntity) PvZEntity.BERSERKER.create(serverWorld, itemStack.getTag(), (Text) null, context.getPlayer(), blockPos, SpawnReason.SPAWN_EGG, true, true);
                    ...
                    world.spawnEntity(berserkerEntity);
                    world.playSound((PlayerEntity) null, berserkerEntity.getX(), berserkerEntity.getY(), berserkerEntity.getZ(), ExampleMod.ENTITYRISINGEVENT, SoundCategory.BLOCKS, 0.75F, 0.8F);
                }
