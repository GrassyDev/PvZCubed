...
public class LightningReedSeeds extends SeedItem implements FabricItem {
	public static int cooldown = (int) (PVZCONFIG.nestedSeeds.moreSeeds.lightningreedS() * 20);
    public LightningReedSeeds(Settings settings) {
        super(settings);
    }
	...
	public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
		...
		tooltip.add(Text.translatable("item.pvzmod.lightningreed_seed_packet.flavour")
	...
	private LightningReedEntity createEntity(World world, HitResult hitResult) {
		return (LightningReedEntity) (new LightningReedEntity(world, hitResult.getPos().x, hitResult.getPos().y, hitResult.getPos().z));
	}
