...
public class PvZSounds {
	...
	public static void registerSounds() {
		Registry.register(Registry.SOUND_EVENT, PvZSounds.LOOTNUGGET, LOOTNUGGETEVENT);
		Registry.register(Registry.SOUND_EVENT, PvZSounds.LOOTDIAMOND, LOOTDIAMONDEVENT);
		Registry.register(Registry.SOUND_EVENT, PvZSounds.LOOTGIFT, LOOTGIFTDEVENT);
		Registry.register(Registry.SOUND_EVENT, PvZSounds.PEASHOOT, PEASHOOTEVENT);
		Registry.register(Registry.SOUND_EVENT, PvZSounds.PEAHIT, PEAHITEVENT);
		Registry.register(Registry.SOUND_EVENT, PvZSounds.FIREPEAHIT, FIREPEAHITEVENT);
		Registry.register(Registry.SOUND_EVENT, PvZSounds.CONEHIT, CONEHITEVENT);
		Registry.register(Registry.SOUND_EVENT, PvZSounds.BUCKETHIT, BUCKETHITEVENT);
		Registry.register(Registry.SOUND_EVENT, PvZSounds.STONEHIT, STONEHITEVENT);
		Registry.register(Registry.SOUND_EVENT, PvZSounds.SNOWPEASHOOT, SNOWPEASHOOTEVENT);
		...
		Registry.register(Registry.SOUND_EVENT, PvZSounds.HYPNOTIZING, HYPNOTIZINGEVENT);
		Registry.register(Registry.SOUND_EVENT, PvZSounds.GRAVERISING, GRAVERISINGEVENT);
		Registry.register(Registry.SOUND_EVENT, PvZSounds.ENTITYRISING, ENTITYRISINGEVENT);
		Registry.register(Registry.SOUND_EVENT, PvZSounds.PLANTPLANTED, PLANTPLANTEDEVENT);
		Registry.register(Registry.SOUND_EVENT, PvZSounds.SUNDROP, SUNDROPEVENT);
		Registry.register(Registry.SOUND_EVENT, PvZSounds.ZOMBIEBITE, ZOMBIEBITEEVENT);
		Registry.register(Registry.SOUND_EVENT, PvZSounds.POPLIMB, POPLIMBEVENT);
		...
		Registry.register(Registry.SOUND_EVENT, PvZSounds.KNIGHTTRANSFORM, KNIGHTTRANSFORMEVENT);
		Registry.register(Registry.SOUND_EVENT, PvZSounds.ZOMBIEMOAN, ZOMBIEMOANEVENT);
		Registry.register(Registry.SOUND_EVENT, PvZSounds.IMPMOAN, IMPMOANEVENT);
		Registry.register(Registry.SOUND_EVENT, PvZSounds.NEWSPAPERANGRY, NEWSPAPERANGRYEVENT);
		Registry.register(Registry.SOUND_EVENT, PvZSounds.DOLPHINWATER, DOLPHINWATEREVENT);
		Registry.register(Registry.SOUND_EVENT, PvZSounds.GARGANTUARMOAN, GARGANTUARMOANEVENT);
		Registry.register(Registry.SOUND_EVENT, PvZSounds.SILENCE, SILENCEVENET);
		Registry.register(Registry.SOUND_EVENT, PvZSounds.ZOMBIEDANCING, ZOMBIEDANCINGEVENT);
	}
}
