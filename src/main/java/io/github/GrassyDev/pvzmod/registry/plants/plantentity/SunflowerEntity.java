...
public class SunflowerEntity extends GolemEntity implements IAnimatable {
    ...
    static {
        ATTACHED_BLOCK = DataTracker.registerData(SunflowerEntity.class, TrackedDataHandlerRegistry.OPTIONAL_BLOCK_POS);
    }
