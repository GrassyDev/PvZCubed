...
public class FlagPeasantEntity extends SummonerEntity implements IAnimatable {
	...
	public static DefaultAttributeContainer.Builder createFlagPeasantAttributes() {
        return HostileEntity.createHostileAttributes().add(EntityAttributes.GENERIC_FOLLOW_RANGE, 100.0D)
                ...
                .add(EntityAttributes.GENERIC_MAX_HEALTH, PVZCONFIG.nestedZombieHealth.flagPeasantH());
	}
	...
	protected abstract class CastSpellGoal extends Goal {
		...
		public boolean canStart() {
			...
			if (livingEntity != null && livingEntity.isAlive() && !FlagPeasantEntity.this.hasStatusEffect(PvZCubed.FROZEN) && !FlagPeasantEntity.this.hasStatusEffect(PvZCubed.STUN)) {
