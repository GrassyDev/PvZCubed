	...
	public ActionResult useOnBlock(ItemUsageContext context) {
		...
		if (direction == Direction.DOWN) {
			...
			if (world.isSpaceEmpty((Entity)null, box) && world instanceof ServerWorld serverWorld) {
				...
				List<PlantEntity> list = world.getNonSpectatingEntities(PlantEntity.class, PvZEntity.THREEPEATER.getDimensions().getBoxAt(threepeaterEntity.getPos()));
				if (list.isEmpty()) {
					...
					world.playSound((PlayerEntity) null, threepeaterEntity.getX(), threepeaterEntity.getY(), threepeaterEntity.getZ(), PvZCubed.PLANTPLANTEDEVENT, SoundCategory.BLOCKS, 0.6f, 0.8F);
