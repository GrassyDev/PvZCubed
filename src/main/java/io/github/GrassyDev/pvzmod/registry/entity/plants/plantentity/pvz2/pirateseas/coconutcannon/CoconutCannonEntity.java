...
public class CoconutCannonEntity extends BombardEntity implements IAnimatable, RangedAttackMob {
			...
			if (((!this.coconutCannonEntity.canSee(livingEntity)) &&
				...
				if (this.beamTicks >= 0 && this.coconutCannonEntity.rechargeTime <= 0) {
					if (!this.coconutCannonEntity.isInsideWaterOrBubbleColumn()) {
						...
						double time = (this.coconutCannonEntity.squaredDistanceTo(livingEntity) > 36) ? 50 : 1;
