...
public class DoomshroomEntity extends BombardEntity implements IAnimatable {
    ...
    static {
        ATTACHED_BLOCK = DataTracker.registerData(DoomshroomEntity.class, TrackedDataHandlerRegistry.OPTIONAL_BLOCK_POS);
    }
    ...
    private void explode() {
        if (!this.world.isClient) {
            PvZExplosion explosion = new PvZExplosion(world, this, this.getX(), this.getY(), this.getZ(), 5f, null, Explosion.DestructionType.NONE);
    ...
    private void spawnEffectsCloud() {
        Collection<StatusEffectInstance> collection = this.getStatusEffects();
            ...
            areaEffectCloudEntity.setRadius(16F);
