...
public class FlagMummyEntityRenderer extends GeoEntityRenderer<FlagMummyEntity> {
	...
	@Override
	public void render(GeoModel model, FlagMummyEntity animatable, float partialTick, RenderLayer type, MatrixStack poseStack, @Nullable VertexConsumerProvider bufferSource, @Nullable VertexConsumer buffer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
