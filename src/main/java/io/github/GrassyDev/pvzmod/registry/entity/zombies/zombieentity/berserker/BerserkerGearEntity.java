...
public class BerserkerGearEntity extends ZombiePropEntity implements IAnimatable {
    private AnimationFactory factory = GeckoLibUtil.createFactory(this);
    private String controllerName = "shieldcontroller";

    public BerserkerGearEntity(EntityType<? extends BerserkerGearEntity> entityType, World world) {
