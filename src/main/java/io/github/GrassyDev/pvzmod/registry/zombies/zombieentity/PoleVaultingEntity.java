...
public class PoleVaultingEntity extends HostileEntity implements IAnimatable {
    ...
    protected void initCustomGoals() {
        ...
        this.targetSelector.add(2, new TargetGoal(this, ThreepeaterEntity.class, false, true));
        this.targetSelector.add(2, new TargetGoal(this, SnowpeaEntity.class, false, true));
        this.targetSelector.add(2, new TargetGoal(this, SunflowerEntity.class, false, true));
        this.targetSelector.add(2, new TargetGoal(this, SunshroomEntity.class, false, true));
        this.targetSelector.add(2, new TargetGoal(this, PuffshroomEntity.class, false, true));
        this.targetSelector.add(2, new TargetGoal(this, FumeshroomEntity.class, false, true));
        this.targetSelector.add(2, new TargetGoal(this, RepeaterEntity.class, false, true));
        this.targetSelector.add(2, new TargetGoal(this, MerchantEntity.class, false, true));
        this.targetSelector.add(3, new TargetGoal(this, IronGolemEntity.class, false, true));
