...
public class HypnoshroomEntity extends PlantEntity implements IAnimatable, RangedAttackMob {
	...
	protected void awakeGoals(){
		...
		this.targetSelector.add(1, new TargetGoal<>(this, MobEntity.class, 0, false, false, (livingEntity) -> {
			return livingEntity instanceof GeneralPvZombieEntity generalPvZombieEntity && !(generalPvZombieEntity.getHypno()) && !(generalPvZombieEntity.isCovered()) && generalPvZombieEntity.canHypno()&&
