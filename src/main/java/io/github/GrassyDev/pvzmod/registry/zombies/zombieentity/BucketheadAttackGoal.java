...
public class BucketheadAttackGoal extends MeleeAttackGoal {
   private final BucketheadEntity pvzombie;
   private int ticks;

   public BucketheadAttackGoal(BucketheadEntity pvzombie, double speed, boolean pauseWhenMobIdle) {
