...
public class ElectricpeaItem extends Item {
    public ElectricpeaItem(Settings settings) {
        super(settings);
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        if (!world.isClient) {
            ShootingElectricPeaEntity proj = new ShootingElectricPeaEntity(PvZEntity.ELECTRICPEA, world);
