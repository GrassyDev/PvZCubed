...
public class HypnoPoleVaultingAttackGoal extends MeleeAttackGoal {
   private final HypnoPoleVaultingEntity pvzombie;
   private int ticks;

   public HypnoPoleVaultingAttackGoal(HypnoPoleVaultingEntity pvzombie, double speed, boolean pauseWhenMobIdle) {
