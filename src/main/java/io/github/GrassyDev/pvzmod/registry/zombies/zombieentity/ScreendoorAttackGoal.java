...
public class ScreendoorAttackGoal extends MeleeAttackGoal {
   private final ScreendoorEntity pvzombie;
   private int ticks;

   public ScreendoorAttackGoal(ScreendoorEntity pvzombie, double speed, boolean pauseWhenMobIdle) {
