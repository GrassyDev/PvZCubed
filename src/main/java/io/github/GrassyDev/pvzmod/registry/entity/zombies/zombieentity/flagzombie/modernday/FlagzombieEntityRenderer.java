...
public class FlagzombieEntityRenderer extends GeoEntityRenderer<FlagzombieEntity> {
	...
	@Override
	public void render(GeoModel model, FlagzombieEntity animatable, float partialTick, RenderLayer type, MatrixStack poseStack, @Nullable VertexConsumerProvider bufferSource, @Nullable VertexConsumer buffer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
