...
public class BackupDancerAttackGoal extends MeleeAttackGoal {
   private final BackupDancerEntity pvzombie;
   private int ticks;

   public BackupDancerAttackGoal(BackupDancerEntity pvzombie, double speed, boolean pauseWhenMobIdle) {
