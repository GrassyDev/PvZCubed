...
public class ScreendoorEntity extends HostileEntity implements IAnimatable {
    ...
    public ScreendoorEntity(EntityType<? extends ScreendoorEntity> entityType, World world) {
    ...
    public ScreendoorEntity(World world) {
        this(PvZEntity.SCREEENDOOR, world);
    }
    ...
    protected void initCustomGoals() {
        ...
        this.goalSelector.add(1, new ScreendoorAttackGoal(this, 1.0D, true));
    ...
    public boolean damage(DamageSource source, float amount) {
        if (!super.damage(source, amount)) {
            ...
            if (this.getRecentDamageSource() == DamageSource.OUT_OF_WORLD) {
                ...
                hypnoScreendoorEntity.refreshPositionAndAngles(this.getX(), this.getY(), this.getZ(), this.yaw, this.pitch);
    ...
    public EntityData initialize(ServerWorldAccess world, LocalDifficulty difficulty, SpawnReason spawnReason, @Nullable EntityData entityData, @Nullable NbtCompound entityTag) {
        ...
        if (entityData instanceof ScreendoorEntity.ZombieData) {
            ScreendoorEntity.ZombieData zombieData = (ScreendoorEntity.ZombieData)entityData;
    ...
    public static boolean canScreendoorSpawn(EntityType<ScreendoorEntity> entity, WorldAccess world, SpawnReason reason, BlockPos pos, Random rand) {
        return pos.getY() > 55;
    }
    ...
    class TrackOwnerTargetGoal extends TrackTargetGoal {
        ...
        public boolean canStart() {
            return ScreendoorEntity.this.owner != null && ScreendoorEntity.this.owner.getTarget() != null && this.canTrack(ScreendoorEntity.this.owner.getTarget(), this.TRACK_OWNER_PREDICATE);
        }

        public void start() {
            ScreendoorEntity.this.setTarget(ScreendoorEntity.this.owner.getTarget());
            super.start();
        }
    }
