...
public class BucketheadEntity extends PvZombieEntity implements IAnimatable {
	...
	private <P extends IAnimatable> PlayState predicate(AnimationEvent<P> event) {
		...
		BucketheadGearEntity bucketheadGearEntity = (BucketheadGearEntity) this.getFirstPassenger();
		if (vehicle instanceof DuckyTubeEntity) {
			if (this.hasPassenger(bucketheadGearEntity)) {
	...
	public boolean damage(DamageSource source, float amount) {
        if (!super.damage(source, amount)) {
            ...
            if (this.getRecentDamageSource() == PvZCubed.HYPNO_DAMAGE) {
                ...
                HypnoBucketheadEntity hypnotizedZombie = (HypnoBucketheadEntity) PvZEntity.HYPNOBUCKETHEAD.create(world);
