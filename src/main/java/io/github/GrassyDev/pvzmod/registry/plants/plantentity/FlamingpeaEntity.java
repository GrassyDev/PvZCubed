...
public class FlamingpeaEntity extends GolemEntity implements IAnimatable, RangedAttackMob {
    ...
    static {
        ATTACHED_BLOCK = DataTracker.registerData(FlamingpeaEntity.class, TrackedDataHandlerRegistry.OPTIONAL_BLOCK_POS);
    }
    ...
    static {
        SNOW_GOLEM_FLAGS = DataTracker.registerData(FlamingpeaEntity.class, TrackedDataHandlerRegistry.BYTE);
    }
}
