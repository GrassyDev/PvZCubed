...
public class HypnoProjEntity extends PvZProjectileEntity implements IAnimatable {
    ...
    public void handleStatus(byte status) {
        ...
        if (status == 3) {
			...
			for (int j = 0; j < 16; ++j) {
				this.world.addParticle(new BlockStateParticleEffect(ParticleTypes.BLOCK, Blocks.PINK_CONCRETE.getDefaultState()), this.getX(), this.getY(), this.getZ(), d, e, f);
			}
        }
