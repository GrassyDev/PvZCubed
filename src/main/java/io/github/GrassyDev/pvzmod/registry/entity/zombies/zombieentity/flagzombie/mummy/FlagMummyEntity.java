...
public class FlagMummyEntity extends SummonerEntity implements IAnimatable {
	...
	public boolean damage(DamageSource source, float amount) {
		if (!super.damage(source, amount)) {
			...
			if (this.getRecentDamageSource() == PvZCubed.HYPNO_DAMAGE && !(this.getHypno())) {
				...
				FlagMummyEntity hypnotizedZombie = (FlagMummyEntity) hypnoType.create(world);
    ...
    class summonZombieGoal extends CastSpellGoal {
        ...
        protected void castSpell() {
            ...
            ServerWorld serverWorld = (ServerWorld) FlagMummyEntity.this.world;
    ...
    class TrackOwnerTargetGoal extends TrackTargetGoal {
        ...
        public boolean canStart() {
            return FlagMummyEntity.this.owner != null && FlagMummyEntity.this.owner.getTarget() != null && this.canTrack(FlagMummyEntity.this.owner.getTarget(), this.TRACK_OWNER_PREDICATE);
        }

        public void start() {
            FlagMummyEntity.this.setTarget(FlagMummyEntity.this.owner.getTarget());
            super.start();
        }
    }
}
