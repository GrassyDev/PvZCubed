        ...
        if (direction == Direction.DOWN) {
            ...
            if (world.isSpaceEmpty((Entity) null, box, (entity) -> {
                ...
                if (world instanceof ServerWorld) {
                    ...
                    DoomshroomEntity doomshroomEntity = (DoomshroomEntity) PvZEntity.DOOMSHROOM.create(serverWorld, itemStack.getTag(), (Text) null, context.getPlayer(), blockPos, SpawnReason.SPAWN_EGG, true, true);
