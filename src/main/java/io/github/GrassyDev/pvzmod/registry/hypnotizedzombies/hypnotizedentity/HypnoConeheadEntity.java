...
public class HypnoConeheadEntity extends GolemEntity implements IAnimatable {
...
public HypnoConeheadEntity(EntityType<? extends HypnoConeheadEntity> entityType, World world) {
...
public HypnoConeheadEntity(World world) {
    this(PvZEntity.HYPNOCONEHEAD, world);
}
...
protected void initCustomGoals() {
    this.targetSelector.add(2, new HypnoConeheadEntity.TrackOwnerTargetGoal(this));
    this.goalSelector.add(1, new HypnoConeheadAttackGoal(this, 1.0D, true));
...
public static DefaultAttributeContainer.Builder createHypnoConeheadAttributes() {
...
class TrackOwnerTargetGoal extends TrackTargetGoal {
    ...
    public boolean canStart() {
        return HypnoConeheadEntity.this.owner != null && HypnoConeheadEntity.this.owner.getTarget() != null && this.canTrack(HypnoConeheadEntity.this.owner.getTarget(), this.TRACK_OWNER_PREDICATE);
    }

    public void start() {
        HypnoConeheadEntity.this.setTarget(HypnoConeheadEntity.this.owner.getTarget());
        super.start();
    }
}
