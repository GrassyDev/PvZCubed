...
public class AnnouncerImpEntityRenderer extends GeoEntityRenderer<AnnouncerImpEntity> {
	...
	@Override
	public void render(GeoModel model, AnnouncerImpEntity animatable, float partialTick, RenderLayer type, MatrixStack poseStack, @Nullable VertexConsumerProvider bufferSource, @Nullable VertexConsumer buffer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
