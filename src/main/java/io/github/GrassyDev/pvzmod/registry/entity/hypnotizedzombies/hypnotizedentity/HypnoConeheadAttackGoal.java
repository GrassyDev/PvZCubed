...
public class HypnoConeheadAttackGoal extends MeleeAttackGoal {
   private final HypnoConeheadEntity pvzombie;
   private int ticks;

   public HypnoConeheadAttackGoal(HypnoConeheadEntity pvzombie, double speed, boolean pauseWhenMobIdle) {
