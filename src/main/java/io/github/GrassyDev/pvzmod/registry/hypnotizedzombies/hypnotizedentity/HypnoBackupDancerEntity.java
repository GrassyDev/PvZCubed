...
public HypnoBackupDancerEntity(EntityType<? extends HypnoBackupDancerEntity> entityType, World world) {
...
public HypnoBackupDancerEntity(World world) {
    this(PvZEntity.HYPNOBACKUPDANCER, world);
}
...
public static DefaultAttributeContainer.Builder createHypnoBackupDancerAttributes() {
...
class TrackOwnerTargetGoal extends TrackTargetGoal {
    ...
    public boolean canStart() {
        return HypnoBackupDancerEntity.this.owner != null && HypnoBackupDancerEntity.this.owner.getTarget() != null && this.canTrack(HypnoBackupDancerEntity.this.owner.getTarget(), this.TRACK_OWNER_PREDICATE);
    }

    public void start() {
        HypnoBackupDancerEntity.this.setTarget(HypnoBackupDancerEntity.this.owner.getTarget());
        super.start();
    }
}
