...
public class HypnoPoleVaultingEntity extends GolemEntity implements IAnimatable {
...
public HypnoPoleVaultingEntity(World world) {
    this(PvZEntity.HYPNOPOLEVAULTING, world);
}
...
protected void initCustomGoals() {
    ...
    this.goalSelector.add(1, new HypnoPoleVaultingAttackGoal(this, 1.0D, true));
