...
public class HypnoBerserkerEntity extends HypnoZombieEntity implements IAnimatable {
	...
	private static final TrackedData<Boolean> DATA_ID_TYPE_COUNT =
			DataTracker.registerData(HypnoBerserkerEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
	...
	public void setTackleStage(HypnoBerserkerEntity.TackleStage tackleStage) {
			...
			if (this.getTackleStage()) {
				if (i <= 0) {
					if (this.hasStatusEffect(PvZCubed.ICE)) {
						...
						this.setTackleStage(HypnoBerserkerEntity.TackleStage.EATING);
						return bl;
					} else {
						this.attackTicksLeft = 20;
						float f = 180f;
