        ...
        if (direction == Direction.DOWN) {
            ...
            if (world.isSpaceEmpty((Entity) null, box, (entity) -> {
                ...
                if (world instanceof ServerWorld) {
                    ...
                    FumeshroomEntity fumeshroomEntity = (FumeshroomEntity) PvZEntity.FUMESHROOM.create(serverWorld, itemStack.getTag(), (Text) null, context.getPlayer(), blockPos, SpawnReason.SPAWN_EGG, true, true);
                    ...
                    world.playSound((PlayerEntity) null, fumeshroomEntity.getX(), fumeshroomEntity.getY(), fumeshroomEntity.getZ(), ExampleMod.PLANTPLANTEDEVENT, SoundCategory.BLOCKS, 0.75F, 0.8F);
                }
