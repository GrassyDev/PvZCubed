...
import net.fabricmc.example.registry.hypnotizedzombies.models.HypnoBucketheadEntityModel;
...
public class HypnoBucketheadEntityRenderer extends GeoEntityRenderer<HypnoBucketheadEntity> {
    ...
    public HypnoBucketheadEntityRenderer(EntityRenderDispatcher renderManager) {
        super(renderManager, new HypnoBucketheadEntityModel());
