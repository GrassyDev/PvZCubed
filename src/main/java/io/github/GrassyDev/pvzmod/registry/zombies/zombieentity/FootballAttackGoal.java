...
public class FootballAttackGoal extends MeleeAttackGoal {
   private final FootballEntity pvzombie;
   private int ticks;

   public FootballAttackGoal(FootballEntity pvzombie, double speed, boolean pauseWhenMobIdle) {
