    ...
    public Identifier getTextureResource(PeasantEntity object)
	{
		...
		if (object.getHypno()){
			...
			if (object.armless && object.geardmg){
				identifier = new Identifier("pvzmod", "textures/entity/browncoat/peasant/peasant_dmg1_geardmg1_hypnotized.png");
			}
			else if (object.armless && object.gearless){
				identifier = new Identifier("pvzmod", "textures/entity/browncoat/peasant/peasant_gearless_dmg1_hypnotized.png");
			}
			else if (object.gearless){
				identifier = new Identifier("pvzmod", "textures/entity/browncoat/peasant/peasant_gearless_hypnotized.png");
			}
			else if (object.geardmg){
				identifier = new Identifier("pvzmod", "textures/entity/browncoat/peasant/peasant_geardmg1_hypnotized.png");
			}
