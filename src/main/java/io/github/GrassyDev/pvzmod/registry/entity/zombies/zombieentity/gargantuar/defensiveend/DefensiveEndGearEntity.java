...
public class DefensiveEndGearEntity extends ZombiePropEntity implements IAnimatable {
    private AnimationFactory factory = GeckoLibUtil.createFactory(this);
    private String controllerName = "shieldcontroller";

    public DefensiveEndGearEntity(EntityType<? extends DefensiveEndGearEntity> entityType, World world) {
