...
public class ConeheadEgg extends SeedItem {
	...
	public ActionResult useOnBlock(ItemUsageContext context) {
		...
		if (world.isSpaceEmpty((Entity) null, box) && world instanceof ServerWorld serverWorld) {
				BrowncoatEntity zombieEntity = (BrowncoatEntity) PvZEntity.CONEHEAD.create(serverWorld, itemStack.getNbt(), (Text) null, context.getPlayer(), blockPos, SpawnReason.SPAWN_EGG, true, true);
