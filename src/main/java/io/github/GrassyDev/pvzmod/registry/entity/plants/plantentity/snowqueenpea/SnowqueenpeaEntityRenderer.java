...
import io.github.GrassyDev.pvzmod.registry.entity.plants.plantentity.snowpea.SnowpeaEntityModel;
	...
	public static final Map<SnowQueenPeaVariants, Identifier> LOCATION_BY_VARIANT =
			Util.make(Maps.newEnumMap(SnowQueenPeaVariants.class), (map) -> {
				map.put(SnowQueenPeaVariants.DEFAULT,
						new Identifier(PvZCubed.MOD_ID, "textures/entity/peashooter/snowqueenpea.png"));
