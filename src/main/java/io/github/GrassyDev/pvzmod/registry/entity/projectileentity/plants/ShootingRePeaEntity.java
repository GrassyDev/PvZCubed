...
public class ShootingRePeaEntity extends ThrownItemEntity {

    public static final Identifier PacketID = new Identifier(PvZEntity.ModID, "repea");

    public ShootingRePeaEntity(EntityType<? extends ThrownItemEntity> entityType, World world) {
        super(entityType, world);
    }

    public ShootingRePeaEntity(World world, LivingEntity owner) {
        super(EntityType.SNOWBALL, owner, world);
    }

    @Environment(EnvType.CLIENT)
    public ShootingRePeaEntity(World world, double x, double y, double z, float yaw, float pitch, int interpolation, boolean interpolate, int id, UUID uuid) {
        super(PvZEntity.REPEA, world);
    ...
    protected void onEntityHit(EntityHitResult entityHitResult) {
        ...
        if ((entity instanceof BucketheadEntity) ||
            ...
            entity.playSound(PvZCubed.REPEABUCKETHITEVENT, 0.25F, 1F);
            ...
            float sound = this.random.nextFloat();
            entity.playSound(PvZCubed.REPEACONEHITEVENT, 0.25F, 1F);
            entity.damage(DamageSource.thrownProjectile(this, this.getOwner()), 16);
            this.world.sendEntityStatus(this, (byte) 3);
            this.remove(RemovalReason.DISCARDED);
        }
            ...
            float sound = this.random.nextFloat();
            entity.playSound(PvZCubed.REPEAHITEVENT, 0.25F, 1F);
            entity.damage(DamageSource.thrownProjectile(this, this.getOwner()), 16);
            this.world.sendEntityStatus(this, (byte) 3);
            this.remove(RemovalReason.DISCARDED);
        }
