        ...
        if (direction == Direction.DOWN) {
            ...
            if (world.isSpaceEmpty((Entity) null, box, (entity) -> {
                ...
                if (world instanceof ServerWorld) {
                    ...
                    SunshroomEntity sunshroomEntity = (SunshroomEntity) PvZEntity.SUNSHROOM.create(serverWorld, itemStack.getTag(), (Text) null, context.getPlayer(), blockPos, SpawnReason.SPAWN_EGG, true, true);
                    ...
                    world.playSound((PlayerEntity) null, sunshroomEntity.getX(), sunshroomEntity.getY(), sunshroomEntity.getZ(), ExampleMod.PLANTPLANTEDEVENT, SoundCategory.BLOCKS, 0.75F, 0.8F);
                }
